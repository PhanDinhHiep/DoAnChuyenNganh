...
<div class="col-lg-9" style="padding-top: 20px; padding-bottom:20px;">
    <form method="post" action="ad_duyetdonhang.jsp">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <label for="firstName">Nhân viên duyệt</label>
                <input type="text" class="form-control" name="ngaydat" readonly=""  id="firstName" placeholder="" value="<%=ctdh.getSodtnv() + "-" + Nhanvien.laytennvGiao(ctdh.getSodtnv())%>" required>
            </div>
            <div class="col-md-6 mb-3">
                <label for="firstName">Nhân viên giao</label>
                <input type="text" class="form-control" name="ngaydat" readonly=""  id="firstName" placeholder="" value="<%=ctdh.getNhanviengiao() + "-" + Nhanvien.laytennvGiao(ctdh.getNhanviengiao())%>" required>
            </div>
        </div>
        ...
        <label class="col-md-12 text-center text-danger"><h4>Tổng Tiền: <%=FotmatSo.fm(ctdh.getTongtien())%></h4></label>
