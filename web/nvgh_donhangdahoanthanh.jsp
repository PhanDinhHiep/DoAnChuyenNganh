...
<%
    ArrayList<Donhang> dh = Donhang.layDonHangHoanthanh(nv.getSodtnv());
%>
<div class="col-lg-9" style="padding-top: 20px;">
    <div class="container">
        <h4 style="color: #005cbf">Danh sách đơn hàng đã hoàn thành</h4>
        <h5>Có tổng số <%=dh.size()%> đơn hàng đã hoàn thành</h5>
        <table class="table table-striped" style="border: #495057; background-color: white;">
            <thead>
                <tr>
                    ...
                    <th scope="col" style="color: #005cbf">Ngày giao hàng</th>
            ...
            <tbody>
                ...
                <tr>                   
                    ...
                    <td class="list-group-item-primary"><%=elem.getNgaygiaohang()%></td>
